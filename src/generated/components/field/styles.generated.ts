...
export const lightStyles = `nds-field {
display: block;
  color: var(--nds-color-text);
  font-family: var(--nds-typography-font-family-sans);
}
...
nds-field .nds-field__root {
display: grid;
  gap: var(--nds-spacing-2);
}

nds-field .nds-field__label {
display: inline-flex;
  align-items: center;
  gap: var(--nds-spacing-1);
  color: var(--nds-color-text);
...
nds-field .nds-field__required,
nds-field .nds-field__error {
color: var(--nds-color-accent);
}

nds-field .nds-field__control {
display: block;
}

nds-field .nds-field__description,
nds-field .nds-field__error {
margin: 0;
  font-size: var(--nds-typography-font-size-sm);
  line-height: var(--nds-typography-line-height-normal);
